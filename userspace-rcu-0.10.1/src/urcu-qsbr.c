...
/***
  ...
  1. if waiting = 2 end the grace period tell the call_rcu thread to move cb's accordingly?
  2. Should allow the synchronize to continue?
...
void synchronize_rcu(void)
{
  ...
  /***
    WAIT FOR ALL READERS TO LEAVE (GP COMPLETION) ONLY FIRST THREAD TO CALL THIS FUNCTION DOES THIS
  ***/
